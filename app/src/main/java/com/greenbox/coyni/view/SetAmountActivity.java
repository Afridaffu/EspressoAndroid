...
public class SetAmountActivity extends LinearLayout implements View.OnClickListener {
    ...
    public SetAmountActivity(Context context){
        this(context,null,0);

    }

    public SetAmountActivity(Context context, AttributeSet attrs){
        this(context,attrs,0);

    }

    public SetAmountActivity(Context context, AttributeSet attrs, int defStyleattr){
    ...
    private void init(Context context,AttributeSet attributeSet){
        LayoutInflater.from(context).inflate(R.layout.activity_set_amount,this,true);
