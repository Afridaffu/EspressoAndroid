            ...
            public void onChanged(TransactionList transactionList) {
                if (transactionList!=null&&transactionList.getData().getItems()!=null&&transactionList.getStatus().equalsIgnoreCase("SUCCESS")) {
                        ...
                        try {
                            ...
                            LinearLayoutManager nLayoutManager=new LinearLayoutManager(TransactionDetailsActivity.this);
                            //Pending RV
                            if (transactionList.getData().getItems().getPendingTransactionsCount()!=0) {
                                ...
                                transactionListPendingAdapter = new TransactionListPendingAdapter(transactionList.getData().getItems().getPendingTransactions(), TransactionDetailsActivity.this);
                            ...
                            if (transactionList.getData().getItems().getPostedTransactions().size()!=0) {
                                ...
                                transactionListPostedAdapter = new TransactionListPostedAdapter(transactionList.getData().getItems().getPostedTransactions(), TransactionDetailsActivity.this);
