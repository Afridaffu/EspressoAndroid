        ...
        try {
            accountLimitsViewModel.getUserAccountLimitsMutableLiveData().observe(this, new Observer<AccountLimits>() {
             ...
             // Buytoken Signet Account
                        ...
                        if (accountLimits.getData().getBuyTokenSignetType()==2){
                        ...
                        if (accountLimits.getData().getBuyTokenSignetType()==3){
                    ...
                    if (accountLimits.getData().getWithdrawsSignetType()==2){
                    ...
                    if (accountLimits.getData().getWithdrawsSignetType()==3){
