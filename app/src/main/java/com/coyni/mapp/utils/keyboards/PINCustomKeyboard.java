...
public class PINCustomKeyboard extends LinearLayout implements View.OnClickListener {
    ...
    public PINCustomKeyboard(Context context){
        this(context,null,0);

    }

    public PINCustomKeyboard(Context context, AttributeSet attrs){
        this(context,attrs,0);

    }

    public PINCustomKeyboard(Context context, AttributeSet attrs, int defStyleattr){
    ...
    private void init(Context context,AttributeSet attributeSet){
        LayoutInflater.from(context).inflate(R.layout.activity_pin_custom_keyboard,this,true);
