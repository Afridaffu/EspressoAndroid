package com.coyni.mapp.utils.CustomeTextView;
...
//        final int wf = 50;
    ...
    public void run() {
        ...
        Shader shader = new LinearGradient(gradientsPositions[1].x, gradientsPositions[1].y, gradientsPositions[0].x, gradientsPositions[0].y, currentColors, null, Shader.TileMode.CLAMP);
