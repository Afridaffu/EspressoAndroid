package com.ideyalabs.wheelpicker.core
...
abstract class WheelPickerActionSheet<Picker : View>(context: Context) {
    ...
    fun setDoneClickButtonListener(listener: View.OnClickListener) {
        contentBinding.tvDone.setOnClickListener(listener)
    }

    fun setContinueClickButtonListener(listener: View.OnClickListener) {
        contentBinding.tvContinue.setOnClickListener(listener)
    }
